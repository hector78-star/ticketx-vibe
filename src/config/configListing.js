...
export const listingFields = [
  ...
  },
  {
    ...
    showConfig: {
      label: 'Seller confirmed transferable',
      isDetail: false,
  ...
  },
  {
    ...
    showConfig: {
      label: 'Seller attested to PDF validity',
      isDetail: false,
      displayOnListingPage: false,
    },
  ...
  },
  {
    ...
    showConfig: {
      label: 'Seller acknowledged handover',
      isDetail: false,
      displayOnListingPage: false,
    },
...
// themselves in the in-app message thread - so the type drives the attestations the seller must
// give, not a delivery mechanism.
